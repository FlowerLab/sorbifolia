...
func (x *Select) IgnoreIndexForOrderBy(args ...string) *Select { x.tx.IgnoreIndexForOrderBy(args...); return x }
func (x *Select) ForceIndexForGroupBy(args ...string) *Select { x.tx.ForceIndexForGroupBy(args...); return x }
func (x *Select) GroupExpr(s string, args ...any) *Select { x.tx.GroupExpr(s, args...); return x }
func (x *Select) IgnoreIndexForGroupBy(args ...string) *Select { x.tx.IgnoreIndexForGroupBy(args...); return x }
func (x *Select) ModelTableExpr(s string, args ...any) *Select { x.tx.ModelTableExpr(s, args...); return x }
func (x *Select) ApplyQueryBuilder(fn func(bun.QueryBuilder) bun.QueryBuilder) *Select { x.tx.ApplyQueryBuilder(fn); return x }
...
func (x *Select) UseIndexForGroupBy(args ...string) *Select { x.tx.UseIndexForGroupBy(args...); return x }
func (x *Select) WherePK(args ...string) *Select { x.tx.WherePK(args...); return x }
func (x *Select) With(name string, query schema.QueryAppender) *Select { x.tx.With(name, query); return x }
...
func (x *Select) ForceIndexForOrderBy(args ...string) *Select { x.tx.ForceIndexForOrderBy(args...); return x }
...
func (x *Select) Relation(s string, fn ...func(*bun.SelectQuery) *bun.SelectQuery) *Select { x.tx.Relation(s, fn...); return x }
...
func (x *Select) WhereGroup(s string, fn func(*bun.SelectQuery) *bun.SelectQuery) *Select { x.tx.WhereGroup(s, fn); return x }
func (x *Select) WithRecursive(name string, query schema.QueryAppender) *Select { x.tx.WithRecursive(name, query); return x }
func (x *Select) UnionAll(q *bun.SelectQuery) *Select { x.tx.UnionAll(q); return x }
func (x *Select) UseIndexForOrderBy(args ...string) *Select { x.tx.UseIndexForOrderBy(args...); return x }
...
func (x *Select) IgnoreIndexForJoin(args ...string) *Select { x.tx.IgnoreIndexForJoin(args...); return x }
...
func (x *Insert) WithRecursive(name string, query schema.QueryAppender) *Insert { x.tx.WithRecursive(name, query); return x }
...
func (x *Insert) ModelTableExpr(s string, args ...any) *Insert { x.tx.ModelTableExpr(s, args...); return x }
...
func (x *Insert) With(name string, query schema.QueryAppender) *Insert { x.tx.With(name, query); return x }
...
func (x *Insert) Value(column string, query string, args ...any) *Insert { x.tx.Value(column, query, args...); return x }
...
func (x *Update) WhereGroup(s string, fn func(*bun.UpdateQuery) *bun.UpdateQuery) *Update { x.tx.WhereGroup(s, fn); return x }
...
func (x *Update) ApplyQueryBuilder(fn func(bun.QueryBuilder) bun.QueryBuilder) *Update { x.tx.ApplyQueryBuilder(fn); return x }
func (x *Update) JoinOnOr(s string, args ...any) *Update { x.tx.JoinOnOr(s, args...); return x }
func (x *Update) Value(column string, query string, args ...any) *Update { x.tx.Value(column, query, args...); return x }
func (x *Update) With(name string, query schema.QueryAppender) *Update { x.tx.With(name, query); return x }
...
func (x *Update) WithRecursive(name string, query schema.QueryAppender) *Update { x.tx.WithRecursive(name, query); return x }
...
func (x *Update) SetColumn(column string, query string, args ...any) *Update { x.tx.SetColumn(column, query, args...); return x }
...
func (x *Update) ModelTableExpr(s string, args ...any) *Update { x.tx.ModelTableExpr(s, args...); return x }
...
func (x *Delete) ModelTableExpr(s string, args ...any) *Delete { x.tx.ModelTableExpr(s, args...); return x }
func (x *Delete) Returning(s string, args ...any) *Delete { x.tx.Returning(s, args...); return x }
func (x *Delete) WhereGroup(s string, fn func(*bun.DeleteQuery) *bun.DeleteQuery) *Delete { x.tx.WhereGroup(s, fn); return x }
func (x *Delete) With(name string, query schema.QueryAppender) *Delete { x.tx.With(name, query); return x }
func (x *Delete) WithRecursive(name string, query schema.QueryAppender) *Delete { x.tx.WithRecursive(name, query); return x }
...
func (x *Delete) ApplyQueryBuilder(fn func(bun.QueryBuilder) bun.QueryBuilder) *Delete { x.tx.ApplyQueryBuilder(fn); return x }
